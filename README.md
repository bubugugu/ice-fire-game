...
這是一款靈感來自《Fireboy and Watergirl》的雙人合作解謎平台遊戲,使用 **Java 21 + JavaFX** 開發。兩名玩家分別操控「火」與「水」兩個角色,必須互相配合觸發按鈕、搭乘電梯、開啟門,合力通過每一關的機關才能收集寶石抵達終點。

這是我改編自大一下期末小組專題,從零開始設計了完整的遊戲迴圈(Game Loop)、2D 碰撞偵測與物理系統、關卡管理系統,以及選單/關卡選擇介面。
